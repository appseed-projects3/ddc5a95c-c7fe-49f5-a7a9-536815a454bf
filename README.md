...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-17 07:37`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ddc5a95c-c7fe-49f5-a7a9-536815a454bf.git
$ cd ddc5a95c-c7fe-49f5-a7a9-536815a454bf
```
